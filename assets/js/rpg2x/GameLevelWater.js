...
class GameLevelWater {
  constructor(path) {
    ...
    const sprite_src_frog = path + "/images/rpg/owl.png";
    ...
    // Audio setup
    this.audio = new Audio(path + '/audio/level-music.mp3'); // Replace with your audio file
    this.audio.loop = true; // Set to true for background looping music
  ...
  // Method to stop the music when level ends (optional)
  stopAudio() {
    if (this.audio) {
      this.audio.pause();
